...
/** Current state, for non-React callers (the keyboard-shortcut handler). */
...
export function useFocusMode() {
  ...
  return {
    enabled: value,
    set: (on: boolean) => setFocusModeEnabled(on),
...
/** Current chrome visibility, for non-React callers and tests. */
